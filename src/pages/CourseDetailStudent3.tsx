            ...
            <div className="flex flex-col lg:flex-row gap-12">
              <div className="flex-1">
                ...
                <div className="flex border-b mb-8">
                  <button className="px-8 py-4 text-gray-500 hover:text-gray-700">Tavsif</button>
                ...
                <div className="bg-white rounded-3xl p-8">
                  <div className="flex items-center gap-5 mb-8">
                    ...
                    />
                    <div>
                      <h3 className="text-2xl font-bold">Akmal Karimov</h3>
                      <p className="text-blue-600">JavaScript Lead</p>
                      <p className="text-sm text-gray-600 mt-1">8 yillik tajriba</p>
                    </div>
                  </div>

                  <p className="text-gray-700 leading-relaxed">
                    Frontend yo'nalishida 8 yillik amaliy tajriba. EPAM va Uzcard kompaniyalarida
                    ishlagan. 540+ talabaga dars bergan, o'rtacha reytingi 4.9.
                  </p>
                </div>
              </div>
