...
export class ReceiptGenerator {
  ...
  generate(data: ReceiptData): Readable {
    ...
    // Header
    doc.fontSize(20).fillColor('#2563EB').text("O'QUV MARKAZ", { align: 'center' }).moveDown(0.2);
    ...
    this.row(doc, "To'langan vaqt:", data.paidAt ? this.formatDate(data.paidAt) : "To'lanmagan");
    ...
    doc
      .fontSize(8)
      .fillColor('#9CA3AF')
      .text('Bu kvitansiya elektron tarzda yaratilgan va imzo talab qilmaydi.', {
        align: 'center',
      });
